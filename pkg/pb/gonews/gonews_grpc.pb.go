...
func (UnimplementedGoNewsServiceServer) NewsFullDetailed(context.Context, *OneNewsRequest) (*DetailedNewsResponse, error) {	return nil, status.Errorf(codes.Unimplemented, "method NewsFullDetailed not implemented")
}
